...
export class AddNewSqlServerCommand implements IAddNewSqlServerCommand {
    instanceName?: string;
    ...
    static fromJS(data: any): AddNewSqlServerCommand {
        data = typeof data === 'object' ? data : {};
...
export interface IAddNewSqlServerCommand {
    instanceName?: string;
}
